...
//    protected ValueAnimator mRadarAnimator;
    ...
    public BezierRadarHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEnableHorizontalDrag = ta.getBoolean(R.styleable.BezierRadarHeader_commonEnableHorizontalDrag, mEnableHorizontalDrag);
        setAccentColor(ta.getColor(R.styleable.BezierRadarHeader_commonAccentColor, 0xFFffffff));
        setPrimaryColor(ta.getColor(R.styleable.BezierRadarHeader_commonPrimaryColor, 0xFF222222));
        mManualAccentColor = ta.hasValue(R.styleable.BezierRadarHeader_commonAccentColor);
        mManualPrimaryColor = ta.hasValue(R.styleable.BezierRadarHeader_commonPrimaryColor);
