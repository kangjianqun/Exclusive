...
public class NineGridImageView<T> extends ViewGroup {
    ...
    public NineGridImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray sTypedArray = context.obtainStyledAttributes(attrs, R.styleable.NineGridImageView);
        mGap = (int) sTypedArray.getDimension(R.styleable.NineGridImageView_commonImgGap,4);
        sTypedArray.recycle();
    }
