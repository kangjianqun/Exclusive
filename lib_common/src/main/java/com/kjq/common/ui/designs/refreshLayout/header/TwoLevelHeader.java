...
import com.kjq.common.ui.designs.refreshLayout.api.OnTwoLevelListener;
...
//    protected Method mRequestDrawBackgroundForHeaderMethod;
    ...
    public TwoLevelHeader(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxRage = ta.getFloat(R.styleable.TwoLevelHeader_commonMaxRage, mMaxRage);
        mFloorRage = ta.getFloat(R.styleable.TwoLevelHeader_commonFloorRage, mFloorRage);
        mRefreshRage = ta.getFloat(R.styleable.TwoLevelHeader_commonRefreshRage, mRefreshRage);
        mFloorDuration = ta.getInt(R.styleable.TwoLevelHeader_commonFloorDuration, mFloorDuration);
        mEnableTwoLevel = ta.getBoolean(R.styleable.TwoLevelHeader_commonEnableTwoLevel, mEnableTwoLevel);
        mEnablePullToCloseTwoLevel = ta.getBoolean(R.styleable.TwoLevelHeader_commonEnablePullToCloseTwoLevel, mEnablePullToCloseTwoLevel);
