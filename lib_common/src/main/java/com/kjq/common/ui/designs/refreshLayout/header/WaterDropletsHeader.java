...
/**
 * 水滴下拉头
 * Created by kjq on 2019/5/24.
 */
public class WaterDropletsHeader extends InternalAbstract implements RefreshHeader {
    ...
    public WaterDropletsHeader(Context context) {
        this(context,null);
    }

    public WaterDropletsHeader(Context context, AttributeSet defStyleAttr) {
        this(context, defStyleAttr,0);
    }

    public WaterDropletsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    void initView(Context context,AttributeSet attrs){
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.WaterDropletsHeader);

        int primaryColor = ta.getColor(R.styleable.WaterDropletsHeader_commonPrimaryColor, 0);
        int accentColor = ta.getColor(R.styleable.WaterDropletsHeader_commonAccentColor, 0);
        if (primaryColor != 0) {
        ...
        if (ta.hasValue(R.styleable.WaterDropletsHeader_commonShadowRadius)) {
            int radius = ta.getDimensionPixelOffset(R.styleable.WaterDropletsHeader_commonShadowRadius, 0);
            int color = ta.getColor(R.styleable.WaterDropletsHeader_commonShadowColor, 0xff000000);
...
//        Resources resources = context.getResources();
    ...
    protected class ProgressAnimationImageView extends ImageView {
        ...
        public ProgressAnimationImageView(Context context) {
            super(context);
            mProgress = new MaterialProgressDrawable(WaterDropletsHeader.this);
