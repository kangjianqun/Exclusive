...
//    protected Map<ValueAnimator, ValueAnimator.AnimatorUpdateListener> mUpdateListeners = new HashMap<>();
    ...
    public BallPulseFooter(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mSpinnerStyle = SpinnerStyle.values()[ta.getInt(R.styleable.BallPulseFooter_commonClassicsSpinnerStyle, mSpinnerStyle.ordinal())];

        if (ta.hasValue(R.styleable.BallPulseFooter_commonNormalColor)) {
            setNormalColor(ta.getColor(R.styleable.BallPulseFooter_commonNormalColor, 0));
        }
        if (ta.hasValue(R.styleable.BallPulseFooter_commonAnimatingColor)) {
            setAnimatingColor(ta.getColor(R.styleable.BallPulseFooter_commonAnimatingColor, 0));
        }
