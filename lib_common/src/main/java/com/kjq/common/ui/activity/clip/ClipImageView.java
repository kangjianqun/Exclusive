package com.kjq.common.ui.activity.clip;
...
public class ClipImageView extends AppCompatImageView implements
    ...
    public ClipImageView(Context context, AttributeSet attrs) {
        ...
        mAspectX = ta.getInteger(R.styleable.ClipImageView_commonBoxWidth, 1);
        mAspectY = ta.getInteger(R.styleable.ClipImageView_commonBoxHeight, 1);
        mClipPadding = ta.getDimensionPixelSize(R.styleable.ClipImageView_commonClipPadding, 0);
        mTipText = ta.getString(R.styleable.ClipImageView_commonTipText);
        mMaskColor = ta.getColor(R.styleable.ClipImageView_commonMaskColor, 0xB2000000);
        mDrawCircleFlag = ta.getBoolean(R.styleable.ClipImageView_commonClipCircle, false);
        mRoundCorner = ta.getDimension(R.styleable.ClipImageView_commonClipRoundCorner, 0);
        final int textSize = ta.getDimensionPixelSize(R.styleable.ClipImageView_commonTipTextSize, 24);
