package com.kjq.common.ui.designs.picker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private void initView() {
        mPickerDialog = new Dialog(mContext, R.style.common_date_picker_dialog);
        mPickerDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        mPickerDialog.setContentView(R.layout.common_dialog_date_picker);
        ...
        mPickerDialog.findViewById(R.id.common_dDPicker_tV_cancel).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.common_dDPicker_tV_confirm).setOnClickListener(this);
        mTvHourUnit = mPickerDialog.findViewById(R.id.common_dDPicker_tV_hour_unit);
        mTvMinuteUnit = mPickerDialog.findViewById(R.id.common_dDPicker_tV_minute_unit);

        mDpvYear = mPickerDialog.findViewById(R.id.common_dDPicker_pV_year);
        mDpvYear.setOnSelectListener(this);
        mDpvMonth = mPickerDialog.findViewById(R.id.common_dDPicker_pV_month);
        mDpvMonth.setOnSelectListener(this);
        mDpvDay = mPickerDialog.findViewById(R.id.common_dDPicker_pV_day);
        mDpvDay.setOnSelectListener(this);
        mDpvHour = mPickerDialog.findViewById(R.id.common_dDPicker_pV_hour);
        mDpvHour.setOnSelectListener(this);
        mDpvMinute = mPickerDialog.findViewById(R.id.common_dDPicker_pV_minute);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.common_dDPicker_tV_cancel) {

        } else if (i == R.id.common_dDPicker_tV_confirm) {
            if (mCallback != null) {
    ...
    public void onSelect(View view, String selected) {
        ...
        int i = view.getId();
        if (i == R.id.common_dDPicker_pV_year) {
            mSelectedTime.set(Calendar.YEAR, timeUnit);
            linkageMonthUnit(true, LINKAGE_DELAY_DEFAULT);
        } else if (i == R.id.common_dDPicker_pV_month) {// 防止类似 2018/12/31 滚动到11月时因溢出变成 2018/12/01
