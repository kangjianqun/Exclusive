package com.kjq.common.ui.designs.wheelView.view;
...
import com.kjq.common.ui.designs.wheelView.adapter.WheelAdapter;
import com.kjq.common.ui.designs.wheelView.interfaces.IPickerViewData;
import com.kjq.common.ui.designs.wheelView.listener.LoopViewGestureListener;
import com.kjq.common.ui.designs.wheelView.listener.OnItemSelectedListener;
import com.kjq.common.ui.designs.wheelView.timer.InertiaTimerTask;
import com.kjq.common.ui.designs.wheelView.timer.MessageHandler;
import com.kjq.common.ui.designs.wheelView.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mGravity = a.getInt(R.styleable.WheelView_commonGravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.WheelView_commonTextColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.WheelView_commonTextColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.WheelView_commonDividerColor, 0xFFd5d5d5);
            textSize = a.getDimensionPixelOffset(R.styleable.WheelView_commonTextSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.WheelView_commonLineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
