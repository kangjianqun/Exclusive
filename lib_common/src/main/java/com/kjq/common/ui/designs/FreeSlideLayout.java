...
import com.kjq.common.utils.ViewHelper;


public class FreeSlideLayout extends FrameLayout {
    // 屏幕宽高
    ...
    public FreeSlideLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public FreeSlideLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public FreeSlideLayout(Context context) {
        super(context);
        init(context);
    }
...
//            }
    ...
    public class ScaleGestureListener implements
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            // 缩放view
            if (scale > 0.5) {
                ViewHelper.setScaleX(FreeSlideLayout.this, scale);// x方向上缩放
                ViewHelper.setScaleY(FreeSlideLayout.this, scale);// y方向上缩放
            }
            return false;
        }
