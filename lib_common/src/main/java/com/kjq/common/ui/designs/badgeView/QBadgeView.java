package com.kjq.common.ui.designs.badgeView;
...
import com.kjq.common.utils.MathUtil;
...
public class QBadgeView extends View implements Badge {
    ...
    protected boolean mB_enableDrag = true;
    ...
    private void init() {
        ...
        mColorBackground = 0xFFFF4206;
        mColorBadgeText = 0xFFFFFFFF;
        mBadgeTextSize = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 11);
        mBadgePadding = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 5);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 5);
        mGravityOffsetY = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 5);
        mFinalDragDistance = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 90);
        mShowShadow = true;
    ...
    @Override
    public Badge enableDrag(boolean enable) {
        mB_enableDrag = enable;
        return this;
    }
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 7);
    ...
    protected Bitmap createBadgeBitmap() {
        Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + ScreenSizeUtils.INSTANCE.dp2px(getContext(), 3),
                (int) mBadgeBackgroundRect.height() + ScreenSizeUtils.INSTANCE.dp2px(getContext(), 3), Bitmap.Config.ARGB_8888);
    ...
    private void showShadowImpl(boolean showShadow) {
        int x = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 1);
        int y = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 1.5f);
        switch (mDragQuadrant) {
            case 1:
                x = ScreenSizeUtils.INSTANCE.dp2px(getContext(), 1);
                y = ScreenSizeUtils.INSTANCE.dp2px(getContext(), -1.5f);
                break;
            case 2:
                x = ScreenSizeUtils.INSTANCE.dp2px(getContext(), -1);
                y = ScreenSizeUtils.INSTANCE.dp2px(getContext(), -1.5f);
        ...
        mBadgeBackgroundPaint.setShadowLayer(showShadow ? ScreenSizeUtils.INSTANCE.dp2px(getContext(), 2f)
                : 0, x, y, 0x33000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                if (mDragOutOfRange = startCircleRadius < ScreenSizeUtils.INSTANCE.dp2px(getContext(), 1.5f)) {
    ...
    public Badge stroke(int color, float width, boolean isDpValue) {
        ...
        mBackgroundBorderWidth = isDpValue ? ScreenSizeUtils.INSTANCE.dp2px(getContext(), width) : width;
        invalidate();
        return this;
    }
    ...
    public Badge setBadgeTextSize(float size, boolean isSpValue) {
        mBadgeTextSize = isSpValue ? ScreenSizeUtils.INSTANCE.dp2px(getContext(), size) : size;
        measureText();
        invalidate();
        return this;
    }
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? ScreenSizeUtils.INSTANCE.px2dp(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }

    @Override
    public Badge setBadgePadding(float padding, boolean isDpValue) {
        mBadgePadding = isDpValue ? ScreenSizeUtils.INSTANCE.dp2px(getContext(), padding) : padding;
        createClipLayer();
        invalidate();
        return this;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? ScreenSizeUtils.INSTANCE.px2dp(getContext(), mBadgePadding) : mBadgePadding;
    }
    ...
    public Badge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
        mGravityOffsetX = isDpValue ? ScreenSizeUtils.INSTANCE.dp2px(getContext(), offsetX) : offsetX;
        mGravityOffsetY = isDpValue ? ScreenSizeUtils.INSTANCE.dp2px(getContext(), offsetY) : offsetY;
        invalidate();
        return this;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? ScreenSizeUtils.INSTANCE.px2dp(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? ScreenSizeUtils.INSTANCE.px2dp(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }
