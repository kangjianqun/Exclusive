...
public class DeviceUtils {
    ...
    private static String getIEMI(@NotNull Context context) {
...
// 可以说是用来标识每一份应用程序的唯一ID（即Installtion ID），可以用来跟踪应用的安装数量等。
    ...
    @SuppressLint("HardwareIds")
    public static String getUniqueId(@NotNull Context context) {
    ...
    public static boolean isWeiBo(){
        return uninstallSoftware(Utils.getContext(),"com.sina.weibo");
    }
    ...
    public static boolean isAlipay() {
        ...
        ComponentName componentName = intent.resolveActivity(Utils.getContext().getPackageManager());
    ...
    @NotNull
    private static String toMD5(@NotNull String text) throws NoSuchAlgorithmException {
        //获取摘要器 MessageDigest
