...
public class GeneralShowActivity extends BaseActivity {
    ...
    public static Intent getNewIntent(Context context, String s_path){
        Intent sIntent = new Intent(context,GeneralShowActivity.class);
    ...
    public static Intent getNewIntent(Context context, String s_path,Object o){
        Intent sIntent = new Intent(context,GeneralShowActivity.class);
        Bundle sBundle = new Bundle();
        sBundle.putString(KEY_PATH,s_path);
        sBundle.putParcelable(KEY_BUNDLE, (Parcelable) o);
        sIntent.putExtra("bundle",sBundle);
        return sIntent;
    }
    ...
    public void initParam(Bundle fragmentOfBundle, Intent activityIntent) {
        ...
        mObject = sBundle.getParcelable(KEY_BUNDLE);
    }
    ...
    public void initData() {
        ...
        if (sO instanceof BaseFragment){
            ...
            if (mObject != null){
                Bundle sBundle = new Bundle();
                sBundle.putParcelable("data", (Parcelable) mObject);
